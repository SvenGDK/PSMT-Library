...
Public Class PS3FixTar
    ...
    Private Sub BrowseTarButton_Click(sender As Object, e As Windows.RoutedEventArgs) Handles BrowseTarButton.Click
    ...
    Private Sub FixTarButton_Click(sender As Object, e As Windows.RoutedEventArgs) Handles FixTarButton.Click
