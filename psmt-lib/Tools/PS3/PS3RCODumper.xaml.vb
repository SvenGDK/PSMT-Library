...
#Region "Browse Buttons"
    ...
    Private Sub BrowseRCOButton_Click(sender As Object, e As Windows.RoutedEventArgs) Handles BrowseRCOButton.Click
    ...
    Private Sub BrowseOutputButton_Click(sender As Object, e As Windows.RoutedEventArgs) Handles BrowseOutputButton.Click
