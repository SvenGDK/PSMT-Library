...
#Region "Browse Buttons"
    ...
    Private Sub BrowseCoreOSPKGButton_Click(sender As Object, e As Windows.RoutedEventArgs) Handles BrowseCoreOSPKGButton.Click
    ...
    Private Sub BrowseDecOutputFolderButton_Click(sender As Object, e As Windows.RoutedEventArgs) Handles BrowseDecOutputFolderButton.Click
    ...
    Private Sub BrowseExtrOutputFolderButton_Click(sender As Object, e As Windows.RoutedEventArgs) Handles BrowseExtrOutputFolderButton.Click
    ...
    Private Sub BrowseDecFolderForEncButton_Click(sender As Object, e As Windows.RoutedEventArgs) Handles BrowseDecFolderForEncButton.Click
    ...
    Private Sub BrowseOutFolderForEncButton_Click(sender As Object, e As Windows.RoutedEventArgs) Handles BrowseOutFolderForEncButton.Click
    ...
    Private Sub BrowseReadButton_Click(sender As Object, e As Windows.RoutedEventArgs) Handles BrowseReadButton.Click
        Dim OFD As New OpenFileDialog() With {.CheckFileExists = True, .Filter = "PKG files (*.pkg)|*.pkg", .Multiselect = False}
        If OFD.ShowDialog() = Forms.DialogResult.OK Then
    ...
    Private Sub BrowseDumpButton_Click(sender As Object, e As Windows.RoutedEventArgs) Handles BrowseDumpButton.Click
        Dim FBD As New FolderBrowserDialog() With {.RootFolder = Environment.SpecialFolder.Desktop, .Description = "Select a decrypted core_os folder", .ShowNewFolderButton = True}
        If FBD.ShowDialog() = Forms.DialogResult.OK Then
