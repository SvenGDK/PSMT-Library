...
#Region "Load Buttons"
    ...
    Private Sub LoadGAMESButton_Click(sender As Object, e As Windows.RoutedEventArgs) Handles LoadGAMESButton.Click
    ...
    Private Sub LoadPS3ISOButton_Click(sender As Object, e As Windows.RoutedEventArgs) Handles LoadPS3ISOButton.Click
    ...
    Private Sub LoadPS2ISOButton_Click(sender As Object, e As Windows.RoutedEventArgs) Handles LoadPS2ISOButton.Click
    ...
    Private Sub LoadPSXISOButton_Click(sender As Object, e As Windows.RoutedEventArgs) Handles LoadPSXISOButton.Click
    ...
    Private Sub LoadPSPISOButton_Click(sender As Object, e As Windows.RoutedEventArgs) Handles LoadPSPISOButton.Click
    ...
    Private Sub LoadROMSButton_Click(sender As Object, e As Windows.RoutedEventArgs) Handles LoadROMSButton.Click
    ...
    Private Sub LoadGAMEIButton_Click(sender As Object, e As Windows.RoutedEventArgs) Handles LoadGAMEIButton.Click
    ...
    Private Sub LoadPKGButton_Click(sender As Object, e As Windows.RoutedEventArgs) Handles LoadPKGButton.Click
    ...
    Private Sub LoadREDKEYButton_Click(sender As Object, e As Windows.RoutedEventArgs) Handles LoadREDKEYButton.Click
    ...
    Private Sub LoadBDISOButton_Click(sender As Object, e As Windows.RoutedEventArgs) Handles LoadBDISOButton.Click
    ...
    Private Sub LoadDVDISOButton_Click(sender As Object, e As Windows.RoutedEventArgs) Handles LoadDVDISOButton.Click
    ...
    Private Sub LoadPICTUREButton_Click(sender As Object, e As Windows.RoutedEventArgs) Handles LoadPICTUREButton.Click
    ...
    Private Sub LoadMOVIESButton_Click(sender As Object, e As Windows.RoutedEventArgs) Handles LoadMOVIESButton.Click
    ...
    Private Sub LoadMUSICButton_Click(sender As Object, e As Windows.RoutedEventArgs) Handles LoadMUSICButton.Click
