...
#Region "Browse Buttons"
    ...
    Private Sub BrowseIMGButton_Click(sender As Object, e As Windows.RoutedEventArgs) Handles BrowseIMGButton.Click
    ...
    Private Sub BrowsePBPOutputButton_Click(sender As Object, e As Windows.RoutedEventArgs) Handles BrowsePBPOutputButton.Click
    ...
    Private Sub BrowseISOButton_Click(sender As Object, e As Windows.RoutedEventArgs) Handles BrowseISOButton.Click
    ...
    Private Sub BrowseISOOutputButton_Click(sender As Object, e As Windows.RoutedEventArgs) Handles BrowseISOOutputButton.Click
        Dim FBD As New FolderBrowserDialog() With {.RootFolder = Environment.SpecialFolder.Desktop, .ShowNewFolderButton = True}
        If FBD.ShowDialog() = Windows.Forms.DialogResult.OK Then
...
#End Region
    ...
    Private Sub ConvertToPBPButton_Click(sender As Object, e As Windows.RoutedEventArgs) Handles ConvertToPBPButton.Click
    ...
    Private Sub ConvertToISOButton_Click(sender As Object, e As Windows.RoutedEventArgs) Handles ConvertToISOButton.Click
