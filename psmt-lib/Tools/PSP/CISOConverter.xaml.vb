...
Public Class CISOConverter
    ...
    Private Sub BrowseCISOButton_Click(sender As Object, e As Windows.RoutedEventArgs) Handles BrowseCISOButton.Click
...
#End Region
    ...
    Private Sub ConvertToCISOButton_Click(sender As Object, e As Windows.RoutedEventArgs) Handles ConvertToCISOButton.Click
