...
#Region "Browse Buttons"
    ...
    Private Sub BrowsePBPButton_Click(sender As Object, e As Windows.RoutedEventArgs) Handles BrowsePBPButton.Click
    ...
    Private Sub BrowsePARAMButton_Click(sender As Object, e As Windows.RoutedEventArgs) Handles BrowsePARAMButton.Click
    ...
    Private Sub BrowseICON0Button_Click(sender As Object, e As Windows.RoutedEventArgs) Handles BrowseICON0Button.Click
    ...
    Private Sub BrowseICON1PMFButton_Click(sender As Object, e As Windows.RoutedEventArgs) Handles BrowseICON1PMFButton.Click
    ...
    Private Sub BrowsePIC0Button_Click(sender As Object, e As Windows.RoutedEventArgs) Handles BrowsePIC0Button.Click
        Dim OFD As New OpenFileDialog() With {.CheckFileExists = True, .Filter = "PNG files (*.PNG)|*.PNG", .Multiselect = False}
        If OFD.ShowDialog() = Windows.Forms.DialogResult.OK Then
    ...
    Private Sub BrowseSND0Button_Click(sender As Object, e As Windows.RoutedEventArgs) Handles BrowseSND0Button.Click
    ...
    Private Sub BrowseDataPSPButton_Click(sender As Object, e As Windows.RoutedEventArgs) Handles BrowseDataPSPButton.Click
    ...
    Private Sub BrowseDATAPSARButton_Click(sender As Object, e As Windows.RoutedEventArgs) Handles BrowseDATAPSARButton.Click
...
#End Region
    ...
    Private Sub UnpackPBPButton_Click(sender As Object, e As Windows.RoutedEventArgs) Handles UnpackPBPButton.Click
        ...
        If Not String.IsNullOrEmpty(SelectedPBPTextBox.Text) And File.Exists(SelectedPBPTextBox.Text) Then
            ...
            Using ISOPBPConverter As New Process()
                ISOPBPConverter.StartInfo.FileName = My.Computer.FileSystem.CurrentDirectory + "\Tools\pbpunpack.exe"
            ...
            If Not Directory.Exists(My.Computer.FileSystem.CurrentDirectory + "\Extracted") Then
                Directory.CreateDirectory(My.Computer.FileSystem.CurrentDirectory + "\Extracted")
                If Not Directory.Exists(My.Computer.FileSystem.CurrentDirectory + "\Extracted\PBP") Then
                    Directory.CreateDirectory(My.Computer.FileSystem.CurrentDirectory + "\Extracted\PBP")
                End If
            End If
            Directory.CreateDirectory(My.Computer.FileSystem.CurrentDirectory + "\Extracted\PBP\" + NewFolder)

            'Move unpacked files
            If File.Exists("PARAM.SFO") Then
                File.Move("PARAM.SFO", My.Computer.FileSystem.CurrentDirectory + "\Extracted\PBP\" + NewFolder + "\PARAM.SFO")
            End If
            If File.Exists("ICON0.PNG") Then
                File.Move("ICON0.PNG", My.Computer.FileSystem.CurrentDirectory + "\Extracted\PBP\" + NewFolder + "\ICON0.PNG")
            End If
            If File.Exists("ICON1.PMF") Then
                File.Move("ICON1.PMF", My.Computer.FileSystem.CurrentDirectory + "\Extracted\PBP\" + NewFolder + "\ICON1.PMF")
            End If
            If File.Exists("PIC0.PNG") Then
                File.Move("PIC0.PNG", My.Computer.FileSystem.CurrentDirectory + "\Extracted\PBP\" + NewFolder + "\PIC0.PNG")
            End If
            If File.Exists("PIC1.PNG") Then
                File.Move("PIC1.PNG", My.Computer.FileSystem.CurrentDirectory + "\Extracted\PBP\" + NewFolder + "\PIC1.PNG")
            End If
            If File.Exists("SND0.AT3") Then
                File.Move("SND0.AT3", My.Computer.FileSystem.CurrentDirectory + "\Extracted\PBP\" + NewFolder + "\SND0.AT3")
            End If
            If File.Exists("DATA.PSP") Then
                File.Move("DATA.PSP", My.Computer.FileSystem.CurrentDirectory + "\Extracted\PBP\" + NewFolder + "\DATA.PSP")
            End If
            If File.Exists("DATA.PSAR") Then
                File.Move("DATA.PSAR", My.Computer.FileSystem.CurrentDirectory + "\Extracted\PBP\" + NewFolder + "\DATA.PSAR")
            End If
            ...
            If MsgBox("Extracted files :" + vbCrLf + vbCrLf + ProcessOutput + vbCrLf + "Do you want to open the folder with the unpacked PBP ?", MsgBoxStyle.YesNo) = MsgBoxResult.Yes Then
                Process.Start("explorer", My.Computer.FileSystem.CurrentDirectory + "\Extracted\PBP\" + NewFolder)
            End If

        End If
    End Sub

    Private Sub PackPBPButton_Click(sender As Object, e As Windows.RoutedEventArgs) Handles PackPBPButton.Click
            ...
            If Not String.IsNullOrEmpty(SelectedICON1TextBox.Text) And File.Exists(SelectedICON1TextBox.Text) And Not String.IsNullOrEmpty(SelectedPIC0TextBox.Text) And File.Exists(SelectedPIC0TextBox.Text) Then
                If Not String.IsNullOrEmpty(SelectedSND0TextBox.Text) And File.Exists(SelectedSND0TextBox.Text) And Not String.IsNullOrEmpty(SelectedDataPSPTextBox.Text) And File.Exists(SelectedDataPSPTextBox.Text) Then
                    If Not String.IsNullOrEmpty(SelectedDataPSARTextBox.Text) And File.Exists(SelectedDataPSARTextBox.Text) And Not String.IsNullOrEmpty(NewFileNameTextBox.Text) Then
                        ...
                        Using ISOPBPConverter As New Process()
                            ISOPBPConverter.StartInfo.FileName = My.Computer.FileSystem.CurrentDirectory + "\Tools\pbppack.exe"
                        ...
                        If Not Directory.Exists(My.Computer.FileSystem.CurrentDirectory + "\Builds") Then
                            Directory.CreateDirectory(My.Computer.FileSystem.CurrentDirectory + "\Builds")
                            If Not Directory.Exists(My.Computer.FileSystem.CurrentDirectory + "\Builds\PBP") Then
                                Directory.CreateDirectory(My.Computer.FileSystem.CurrentDirectory + "\Builds\PBP")
                            End If
                        End If

                        If File.Exists(NewFile) Then
                            File.Move(NewFile, My.Computer.FileSystem.CurrentDirectory + "\Builds\PBP\" + NewFile)
                            If MsgBox(ProcessOutput + vbCrLf + "Do you want to open the folder with the created PBP file ?", MsgBoxStyle.YesNo) = MsgBoxResult.Yes Then
                                Process.Start("explorer", My.Computer.FileSystem.CurrentDirectory + "\Builds\PBP")
                            End If
                        Else
