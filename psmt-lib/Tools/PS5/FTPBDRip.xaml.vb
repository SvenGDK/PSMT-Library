...
Public Class FTPBDRip
    ...
    Private Sub ConnectButton_Click(sender As Object, e As Windows.RoutedEventArgs) Handles ConnectButton.Click
    ...
    Private Sub StartButton_Click(sender As Object, e As Windows.RoutedEventArgs) Handles StartButton.Click
