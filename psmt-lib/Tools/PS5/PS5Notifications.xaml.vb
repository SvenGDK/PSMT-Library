...
Public Class PS5Notifications
    ...
    Private Sub AddWebBrowserButton_Click(sender As Object, e As RoutedEventArgs) Handles AddWebBrowserButton.Click
        ...
        Dim NewPS5Notification As New PS5Notification() With {
            ...
            .isAnonymous = True,
            .isImmediate = True,
            .platformViews = New PlatformViews() With {.previewDisabled = New PreviewDisabled() With {.viewData = New ViewData() With {.icon = New psmt_lib.Icon() With {.parameters = New Parameters() With {.icon = "download"}, .type = ""}, .message = New Message() With {.body = ""}}}},
            .priority = 1,
    ...
    Private Sub UserProfilesComboBox_SelectionChanged(sender As Object, e As Controls.SelectionChangedEventArgs) Handles UserProfilesComboBox.SelectionChanged
        If UserProfilesComboBox.SelectedItem IsNot Nothing Then
            SelectedUserProfile = UserProfilesComboBox.SelectedItem.ToString
        End If
    End Sub

    Private Sub OtherActionsComboBox_SelectionChanged(sender As Object, e As Controls.SelectionChangedEventArgs) Handles OtherActionsComboBox.SelectionChanged
