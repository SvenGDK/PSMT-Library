...
Public Class GP5PKGBuilder
    ...
    Private Sub CreateNewProjectButton_Click(sender As Object, e As Windows.RoutedEventArgs) Handles CreateNewProjectButton.Click
    ...
    Private Sub LoadProjectButton_Click(sender As Object, e As Windows.RoutedEventArgs) Handles LoadProjectButton.Click
    ...
    Private Sub SetBackgroundButton_Click(sender As Object, e As Windows.RoutedEventArgs) Handles SetBackgroundButton.Click
        If Not String.IsNullOrEmpty(CurrentProject.ProjectPath) Then
            Dim OFD As New OpenFileDialog() With {.Title = "Select a new background image", .Filter = "PNG Image (*.png)|*.png", .Multiselect = False}
            If OFD.ShowDialog() = Windows.Forms.DialogResult.OK Then
                'Show new background
    ...
    Private Sub SetSoundtrackButton_Click(sender As Object, e As Windows.RoutedEventArgs) Handles SetSoundtrackButton.Click
        If Not String.IsNullOrEmpty(CurrentProject.ProjectPath) Then
    ...
    Private Sub SetURLButton_Click(sender As Object, e As Windows.RoutedEventArgs) Handles SetURLButton.Click
        If Not String.IsNullOrEmpty(CurrentProject.ProjectPath) Then
    ...
    Private Sub SetContentIDButton_Click(sender As Object, e As Windows.RoutedEventArgs) Handles SetContentIDButton.Click
        If Not String.IsNullOrEmpty(CurrentProject.ProjectPath) Then
    ...
    Private Sub SetTitleIDButton_Click(sender As Object, e As Windows.RoutedEventArgs) Handles SetTitleIDButton.Click
        If Not String.IsNullOrEmpty(CurrentProject.ProjectPath) Then
    ...
    Private Sub SetVersionButton_Click(sender As Object, e As Windows.RoutedEventArgs) Handles SetVersionButton.Click
        If Not String.IsNullOrEmpty(CurrentProject.ProjectPath) Then
